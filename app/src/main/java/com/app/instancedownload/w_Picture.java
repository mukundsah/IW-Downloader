...
public class w_Picture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.w_activity_picture);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog dialog=new Dialog(w_Picture.this);
                dialog.setContentView(R.layout.w_custom_dialog);
                dialog.show();
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent1=new Intent(w_Picture.this, w_MainActivity.class);
